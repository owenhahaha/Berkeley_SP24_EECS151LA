...
{ 
    ...
    "JAL":      ("1101111", lambda a,b: 0, lambda a: a, lambda b: b),
    "JALR":     ("1100111", lambda a,b: 0, lambda a: a, lambda b: b),
...
functs_itype = \
{
    ...
    "SRLI":    ("101", "1", lambda a,b: a>>b, lambda a: a, lambda b: b&0x1f),
    "SRAI":    ("101", "0", lambda a,b: sra(a,b), lambda a: a, lambda b: b&0x1f),
}

functs_rtype = \
{
    "ADD":     ("000", "1", lambda a,b: a+b, lambda a: a, lambda b: b),
    "SUB":     ("000", "0", lambda a,b: sub(a,b), lambda a: a, lambda b: b),
    "SLL":     ("001", "0", lambda a,b: a<<b, lambda a: a, lambda b: b&0x1f),
    "SLT":     ("010", "0", lambda a,b: comp(a,b), lambda a: a, lambda b: b),
    "SLTU":    ("011", "0", lambda a,b: a<b, lambda a: a, lambda b: b),
    ...
    "SRL":     ("101", "1", lambda a,b: a>>b, lambda a: a, lambda b: b&0x1f),
    "SRA":     ("101", "0", lambda a,b: sra(a,b), lambda a: a, lambda b: b&0x1f),
}
